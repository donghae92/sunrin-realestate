    ...
    sections: [
      {
        ...
        text: '주거급여나 LH·도시개발공사 전세임대는 집만 맞는다고 바로 진행되는 것이 아니라, 사람의 자격과 집의 권리관계를 함께 확인해야 하는 경우가 많습니다.',
      },
      {
        heading: '확인이 필요한 항목',
        text: '보증금, 월세, 소득인정액, 금융재산, 지역별 재산 공제 기준, 자기부담분에 따라 실제 부담액이나 진행 가능성이 달라질 수 있습니다. 작은 금액 차이처럼 보여도 심사나 지원액에는 영향을 줄 수 있어, 계약을 먼저 서두르기보다 현재 상황을 차분히 확인해보시는 것이 안전합니다.',
      },
      {
        heading: '상담에서 도와드리는 것',
        text: '선린부동산은 고객님이 어떤 부분을 먼저 확인하셔야 하는지 방향을 안내해드립니다. 계산 구조가 궁금하실 때는 아래 산식 버튼에서 하나씩 확인하실 수 있습니다.',
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        text: '점포나 상가는 집과 달리 권리금, 시설비, 영업 흐름, 기존 단골, 임대조건이 함께 얽히는 경우가 많습니다. 파는 분, 구하는 분, 건물주, 기존 임차인의 입장이 서로 다를 수 있어 조건을 차분히 나누어 정리하는 과정이 필요합니다.',
      },
      {
        heading: '정보 공개 범위 조율',
        text: '영업 중인 점포는 매물 정보가 알려지는 시점과 범위에 따라 권리금 분위기나 영업 흐름에 영향을 줄 수 있습니다. 거래 진행을 위해 필요한 범위는 알리되, 시점과 대상은 상황에 맞춰 조율해드립니다.',
      },
      {
        heading: '함께 확인하는 항목',
        text: '권리금, 시설비, 보증금, 월세, 잔금일, 영업 인수 시점처럼 이해관계가 엇갈리기 쉬운 부분을 하나씩 나누어 확인합니다.',
      },
      {
        heading: '상가건물 임대차보호법 안내',
        text: '상가건물 임대차보호법에서 정한 권리금 회수기회 보호 규정을 참고 자료로 함께 살펴보며, 당사자의 의사를 기준으로 정확하게 상담을 도와드립니다. 다만 개별 사안의 법률적 판단을 대신하는 것은 아닙니다.',
      },
    ],
  },
  {
    ...
    sections: [
      {
        heading: '정리가 필요한 이유',
        text: '주택을 정리하고 다른 곳으로 옮겨가시는 과정은 단순히 매도·매수 한 건으로 끝나지 않는 경우가 많습니다.',
      },
      {
        heading: '확인할 순서',
        text: '기존 임차인 보증금 반환 시점, 매도 잔금일, 새 집 계약금과 잔금일, 이사 일정이 서로 맞물리기 때문에 순서를 먼저 정리해보시는 것이 좋습니다.',
      },
      {
        heading: '가족 지분과 상속',
        text: '부모님 명의 주택, 자녀와의 지분 문제, 상속이나 증여를 함께 고민하시는 경우에도 거래 전에 어떤 쟁점을 확인해야 하는지 차분히 나누어 안내해드립니다.',
      },
      {
        heading: '안내 원칙',
        text: '선린부동산은 세금이나 법률 판단을 대신하지 않습니다. 다만 세무사·법무사 확인이 필요한 지점은 미리 구분해드릴 수 있습니다. 필요하신 내용이 명확하지 않으셔도 괜찮습니다. 먼저 상담 문의를 주시면 방향부터 편하게 안내해드리겠습니다.',
      },
    ],
  },
];
...
const rightsModal: DetailItem = {
  ...
  sections: [
    {
      heading: '권리검토란',
      text: '권리검토는 손님을 불안하게 만들기 위한 절차가 아니라, 계약 전에 확인할 항목을 차분히 나누는 과정입니다.',
    },
    {
      heading: '확인하는 서류',
      text: '등기부에서는 소유자, 근저당, 압류·가압류 가능성, 권리관계 흐름을 확인하고, 건축물대장에서는 용도와 면적이 실제 상담 내용과 맞는지 살펴봅니다.',
    },
    {
      heading: '보조 전문성 안내',
      text: '부동산권리분석사 1급 자격은 이 권리검토 상담에서 보조 전문성으로 활용하고 있습니다. 다만 법률 판단을 대신하는 것이 아니라, 계약 전에 추가 확인이 필요한 지점을 분명하게 안내해드리는 방식입니다.',
    },
    {
      heading: '보증금과 임차관계 확인',
      text: '선순위 보증금과 기존 임차관계는 보증금 안전과 직접 연결될 수 있으므로, 전입·확정일자·우선변제 구조를 따로 확인합니다.',
    },
    {
      heading: '확정하지 않는 부분',
      text: '확정할 수 없는 내용은 단정하지 않고, 추가 확인 항목으로 남겨 고객님이 무리하게 결정하지 않도록 도와드립니다.',
    },
  ],
};
  ...
  sections: [
    {
      ...
      text: '계약 상담은 일반 매매와 전월세만 다루는 창구가 아닙니다. 물건의 종류와 손님의 상황에 따라 먼저 확인해야 할 순서가 달라질 수 있습니다.',
    },
    {
      heading: '매매 · 전월세',
      text: '아파트, 단독주택, 상가주택, 다가구는 각각 살펴봐야 할 서류와 조건이 다릅니다. 등기부, 건축물대장, 임대차 조건, 보증금, 잔금일을 함께 정리해보시는 것이 좋습니다.',
    },
    {
      heading: 'LH · 도시개발공사 전세임대',
      text: '사람의 자격과 집의 권리관계가 함께 맞아야 진행이 수월합니다. 소득인정액, 보증금, 선순위, 전입·확정일자 구조를 함께 살펴봅니다.',
    },
    {
      heading: '점포 · 상가',
      text: '권리금, 영업가치, 정보 공개 범위, 임대인·임차인 이해관계를 당사자 의사에 맞춰 조율합니다.',
    },
    {
      heading: '주택 정리 · 이동',
      text: '잔금 시차, 기존 임차인 보증금 반환, 가족 지분, 상속·증여 검토가 함께 걸릴 수 있어 순서를 차분히 나누어 보는 것이 중요합니다.',
    },
    {
      heading: '상담 이어가기',
      text: '필요한 경우 카카오톡 상담 또는 전화상담으로 이어서 구체적인 일정을 조율해드립니다.',
    },
  ],
};
