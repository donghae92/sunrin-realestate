# 선린공인중개사사무소 모바일 홈페이지 최종 코드 (Next.js/React .tsx)

본 마크다운 문서에는 대구 북구 산격로 95 선린부동산의 공식 9:16 모바일 홈페이지 최종 마스터 코드가 담겨 있습니다.
이 코드는 **`hero-master-final.png`** 이미지의 완벽한 9:16 가독성을 1%도 해치지 않기 위해 불필요한 한글 텍스트 겹침을 원천 차단하고, 유선 **053-944-1116** 직통 연결 및 삼선 메뉴를 통한 색인화된 5대 상담 동선에만 투명 핫스팟 오버레이를 칼같이 매핑한 최상위 모바일 홈 뼈대입니다.

---

## 1. `app/page.tsx` (최종 릴리즈 코드)
