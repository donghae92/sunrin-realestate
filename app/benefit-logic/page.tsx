# 선린공인중개사사무소 주거급여 안심 산식 명세 페이지 (Next.js/React .tsx)

본 마크다운 문서에는 대구광역시(광역시) 기초생활보장법 고시 기준 및 2026년 보건복지부 개정 고시를 철저히 교차 검증하여 완성한 **3대 안심 산식 명세 페이지 최종 코드**가 담겨 있습니다.
대도시 기본재산액 공제한도(7,700만 원)가 아닌 **대구광역시 전용 기준인 8,000만 원**과 금융재산 500만 원 공제, 금융소득 월 10만 원 공제, 1인 가구 사적이전소득 상한선 월 36.6만 원 조항이 수식 엔진에 1원 단위까지 정교하게 탑재되어 있습니다.

---

## 1. `app/benefit-logic/page.tsx` (최종 릴리즈 코드)
